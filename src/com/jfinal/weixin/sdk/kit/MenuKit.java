...
public class MenuKit {
	...
	public static String createMenuJson() {
		...
		btn1.put("name", "开始赚钱");
		btn1.put("url",
				""+SysConstants.OAUTH2_URL+"appid="+SysConstants.WX_APPID+"&redirect_uri=http%3A%2F%2F119.29.75.90%2Fwx%2Frwzq"+str+"");
		...
		btn2_sb1.put("url",
				""+SysConstants.OAUTH2_URL+"appid="+SysConstants.WX_APPID+"&redirect_uri=http%3A%2F%2F119.29.75.90%2Fwx%2Fgrzx"+str+"");
		Map<String, Object> btn2_sb2 = new HashMap<String, Object>();
		btn2_sb2.put("type", "view");
		btn2_sb2.put("name", "收入查询");
		btn2_sb2.put("url",
				""+SysConstants.OAUTH2_URL+"appid="+SysConstants.WX_APPID+"&redirect_uri=http%3A%2F%2F119.29.75.90%2Fwx%2Fsrcx"+str+"");
...
服务中心
	...
	public static String createYchMenu(){
		String wxSerUrl = "http://net023.tunnel.mobi/ych-wx/";
		...
		Map<String, Object> btn2 = new HashMap<String, Object>();
		Map<String, Object> btn3 = new HashMap<String, Object>();
//		List<Map<String, Object>> btn1_sbList = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> btn2_sbList = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> btn3_sbList = new ArrayList<Map<String, Object>>();
